...
function SelectTrigger({
  ...
  // "lg" is a local addition: the trigger's heights are variant-scoped
  // (data-[size=…]:h-8), which tailwind-merge cannot collapse against a plain
  // h-11 from the call site, so a touch-sized trigger needs its own size.
  size?: "sm" | "default" | "lg"
}) {
  return (
